...
from ads_safety_platform.scenarios.scenario_validator import ScenarioValidator, ValidationResult
...
class RealTimeCollector:
    ...
    def collect_scenario(self, scenario_id: int, inject_anomaly: bool = False) -> Optional[AnomalyResult]:
        """收集单个场景"""
        from ads_safety_platform.scenarios import ScenarioBuilder, ScenarioPresets
