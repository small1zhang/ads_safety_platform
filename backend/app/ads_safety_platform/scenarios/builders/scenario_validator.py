...
用法：
    from scenarios.builders.scenario_injector import Scenario, ScenarioBuilder
...
# 导入 RSS 规则模块
from kg_core.rules.rss.longitudinal import (
    LongitudinalRSSModel, RSSLongitudinalParams
)
from kg_core.rules.rss.lateral import (
...
from kg_core.rules.rss.risk_index import (
...
if __name__ == "__main__":
    # 示例：验证所有预设场景
    from scenarios.builders.scenario_injector import ScenarioBuilder, ScenarioPresets
